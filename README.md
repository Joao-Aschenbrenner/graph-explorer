...
ge-qa-full.mjs    suíte QA funcional (21 gates) — isolada via GE_CONFIG_DIR
```

## Qualidade

- 21 gates funcionais de QA cobrem: startup, scan de workspace, geração/cancelamento/retomada de jobs, credenciais de sessão vs criptografadas, modo sem IA, isolamento do webview, cópia de prompt, ausência de porta 3456, ausência de caminhos hardcoded e zero processos órfãos.
